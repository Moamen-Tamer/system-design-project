...
namespace HospitalApp.Models
{
    ...
    public class Doctor
    {
        ...
        public Helpers.Specialization SpecializationType
            => Enum.TryParse<Helpers.Specialization>(Specialization, out var specialization)
                ? specialization
                : Helpers.Specialization.GeneralPractitioner;
