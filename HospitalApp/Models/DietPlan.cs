...
namespace HospitalApp.Models
{
    ...
    public class DietPlan
    {
        ...
        public static DietPlan FromReader(SqlDataReader reader) => new()
        {
            ...
            PatientName = Check.HasColumn(reader, "PatientName") ? reader["PatientName"] as string ?? string.Empty : string.Empty,
            AppointmentDateTime = Check.HasColumn(reader, "AppointmentDateTime") && reader["AppointmentDateTime"] != DBNull.Value
