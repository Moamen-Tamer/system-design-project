...
{
    // Represents a patient's hospital admission record including room assignment, status, and discharge dates.
    public class Admission
    {
        ...
        // Constructs an Admission instance from the current row of a SqlDataReader; optionally reads Fullname if joined.
