...
namespace HospitalApp.Forms.Doctors
{
    ...
    public class DoctorShell: Form
    {
        ...
        public DoctorShell(User user)
        {
            ...
            LoadDoctor();
            IsNutritionist = CurrentDoctor.SpecializationType == Helpers.Specialization.Nutritionist;

            if (!string.IsNullOrWhiteSpace(CurrentDoctor.Fullname))
            {
                doctorName.Text = "Dr. " + CurrentDoctor.Fullname;
        ...
        private void btnDietPlanForm_Click_1(object? sender, EventArgs e)
        {
            ...
            CallPanel(new DietPlansPage(CurrentDoctor));
        ...
        {
            btnDietPlanForm_Click_1(sender, e);
        }
        ...
        {
            panelBtnNutritionistHelper.Visible = false;
            btnNutritionistHelper.Visible = false;
            iconNutritionist.Visible = false;

            panelBtnDietPlanForm.Visible = IsNutritionist;
            ...
            {
                panelBtnViewersControlPage.Location = new Point(0, 200);
            }
        }

        private void ShowPatientsPage()
        {
            Active(btnMyPatientsPage, panelBtnMyPatientsPage);
            CallPanel(new MyPatientsPage(CurrentDoctor));
            TitlePage(btnMyPatientsPage);
