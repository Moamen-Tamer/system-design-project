...
{
    public class MyPatientsPage: Form
    {
        ...
        private void loadPatients(string status, string search)
        {
            ...
            try
            {
                ...
                string like = search == string.Empty ? string.Empty : "AND p.PatientName LIKE @search";
                ...
                while (reader.Read())
                {
                    admissions.Add(new Admission
                    {
                        ...
                        status = (Admission.AdmissionStatus)reader["Status"]
                    });

                    grid.Rows.Add(
                        (int)reader["AddmisionID"],
        ...
        private void detailsClick(Object? sender, EventArgs e)
        {
            ...
            new PatientDetailsForm(admission, currentDoctor).ShowDialog();
    ...
    public class PatientDetailsForm: Form
    {
        ...
        private ComboBox cmbSt = new ComboBox();
        ...
        private void loadData()
        {
            try
            {
                ...
                string query = @"SELECT RoomNumber, AdmittedAt, ExpectedLeave, Status FROM Admission WHERE AdmissionID = @aid";
        ...
        private void saveClick()
        {
            try
            {
                ...
                cmd.Parameters.AddWithValue("@el", cmbSt.SelectedItem!.ToString());
                cmd.Parameters.AddWithValue("@aid", admissionID);
                cmd.ExecuteNonQuery();
    ...
    public class PrescriptionForm: Form
    {
        ...
        private void saveClick(Object? sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string queryRecord = @"INSERT INTO MedicalRecords (PatientID, DoctorID, AdmissionID, Diagnosis, Notes)
