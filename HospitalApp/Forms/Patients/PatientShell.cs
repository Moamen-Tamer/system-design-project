...
namespace HospitalApp.Forms.Patients
{
    ...
    public partial class PatientShell: Form
    {
        ...
        private void ShowPage(string page)
        {
            ...
            {
                "Doctors" => BtnDoctors,
                "BookAppointment" => BtnBookAppointment,
            ...
            UIHelper.SetNavActive(active, BtnDoctors, BtnBookAppointment, BtnAppointments, BtnHistory, BtnViewers, BtnNutrition);

            Control newPage = page switch
            {
                "Doctors" => new DoctorsPage(CurrentPatient),
                "BookAppointment" => new BookAppointment(CurrentPatient),
