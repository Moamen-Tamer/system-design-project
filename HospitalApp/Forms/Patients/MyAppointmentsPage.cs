...
{
    // Page panel showing the patient's own appointments with filter options and cancellation support.
    public partial class MyAppointments: Panel
    {
        ...
        // Queries and populates the grid with the patient's appointments for the given filter.
        ...
        // Cancels the selected appointment after confirming it is still in a cancellable status.
