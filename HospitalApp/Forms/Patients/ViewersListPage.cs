...
{
    // Page panel showing the patient's registered visitors per admission; read-only, managed by their doctor.
    public partial class ViewersList: Panel
    {
        ...
        // Loads all of the patient's admissions into the dropdown for selection.
        ...
        // Loads all registered visitors for the selected admission into the grid.
    ...
    public partial class AddViewerDialog: Form
    {
