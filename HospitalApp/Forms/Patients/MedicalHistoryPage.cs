...
{
    // Page panel showing the patient's full medical record history with linked prescriptions per record.
    public partial class MedicalHistory: Panel
    {
        ...
        // Loads all medical records for the patient into the top grid.
        ...
        // Loads all prescriptions linked to the selected medical record into the prescriptions grid.
